    ...
    return (
      <div id="about"  className="About">
        ...
        <div>
          ...
          <h5>
          Versatile Software developer introduces interpersonal communication and understanding of 
          web development considerations. Excellent organizational skills. Clear understanding of HTML, CSS and JavaScript and training in React. 
          Skilled at designing and developing sites from concept to roll out. Versatile understanding of complex backend data functions and analytics.
          </h5>
